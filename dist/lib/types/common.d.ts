...
export interface LinkElementStateFactory {
    classToModelLinksMap: {
        [index: string]: ModelLinks;
    };
...
export declare type PERMISSION = "create" | "read" | "update" | "delete";
export declare type SimpleType = "STRING" | "BOOLEAN" | "NUMBER" | "DATE";
